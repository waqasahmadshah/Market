    ...
    ***********************************-->
    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Project</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <form id="projectUpdateForm" action="update_projects.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="client" class="form-control" id="client"
                        value="<?= htmlspecialchars($row['client']) ?>" required>
                </div>
