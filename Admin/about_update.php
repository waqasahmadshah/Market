        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Form</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <?php
                    ...
                    <form id="myForm" action="update_about.php" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Title and Sub-title -->
                        <div class="mb-3">
                            <label for="title" class="form-label">Founder Name</label>
                            <input type="text" name="title" class="form-control" id="title" value="<?php echo htmlspecialchars($row['name']); ?>" required>
                        </div>
                        <!-- icon -->
                        <div class="mb-3">
                            <label for="position" class="form-label">position</label>
                            <input type="text" name="position" class="form-control" id="icon" value="<?php echo htmlspecialchars($row['position']); ?>" required>
                        </div>
                        <!-- icon -->
                        <div class="mb-3">
                            <label for="heading" class="form-label">Title</label>
                            <input type="text" name="heading" class="form-control" id="icon" value="<?php echo htmlspecialchars($row['heading']); ?>" required>
                        </div>
                    
                        <!-- Description -->
                        <div class="mb-3">
                            <label for="description" class="form-label">Introduction</label>
