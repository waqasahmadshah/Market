        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="container py-5">
                    ...
                    // Fetch existing data - FIXED SQL QUERY
                    $sql = "SELECT * FROM service_features 
                            LEFT JOIN services 
                            ON service_features.services_id = services.service_id 
                            WHERE service_features.feature_id='$id'";  // Changed ORDER BY to WHERE
                    ...
                    <form id="myForm" action="update_feature_service.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="feature" class="form-control" id="title" 
                                value="<?= htmlspecialchars($row['feature_name']) ?>" required>
                        </div>
