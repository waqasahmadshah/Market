        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Our Values Section</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Records</h4>
                                <a href="ourvalues_add.php" class="btn btn-primary">Insert</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM ourvalues ORDER BY id ASC LIMIT {$offset}, {$limit}";
                                        ...
                                        <table class="table table-responsive-sm">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td><i class='" . htmlspecialchars($row['icon']) . "'></i></td>";
                                                    echo "<td>" . htmlspecialchars($row['created_at']) . "</td>";
                                                    echo "<td><a href='ourvalues_update.php?id=" . htmlspecialchars($row['id']) . "' class='btn btn-warning'>Edit</a></td>";
                                                    echo "<td><a href='delete_ourvalues.php?id=" . htmlspecialchars($row['id']) . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this value?\")'>Delete</a></td>";
                                                    echo "</tr>";
                                                    $serial_no++;
                                                }
                                                ?>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <?php
                                        $count_sql = "SELECT COUNT(*) AS total FROM ourvalues";
                                        ...
                                        if ($total_page > 1) {
                                            ...
                                            if ($page > 1) {
                                                echo '<li class="page-item"><a class="page-link" href="ourvalues.php?page=' . ($page - 1) . '">Prev</a></li>';
                                            }
                                            for ($i = 1; $i <= $total_page; $i++) {
                                                $active = ($i == $page) ? "active" : "";
                                                echo '<li class="page-item ' . $active . '"><a class="page-link" href="ourvalues.php?page=' . $i . '">' . $i . '</a></li>';
                                            }
                                            if ($page < $total_page) {
                                                echo '<li class="page-item"><a class="page-link" href="ourvalues.php?page=' . ($page + 1) . '">Next</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                        ?>
