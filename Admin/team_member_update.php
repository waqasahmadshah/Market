        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Form for Upadtion</h4>
                            <span class="ml-1">Team Member</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="team_member.php">Team Member</a></li>
                ...
                <div class="container py-5">
                    ...
                    // Fetch existing data
                    $sql = "SELECT * FROM teammember WHERE id = $id";
                    ...
                    <form id="myForm" action="update_team_member.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone" class="form-control" id="phone" value="<?php echo htmlspecialchars($row['phone_no']); ?>" >
                        </div>
