            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="portfolio.php">Project</a></li>
                ...
                <div class="container py-5">
                    ...
                    $sql = "SELECT * 
                            FROM portfolio 
                            LEFT JOIN services 
                                ON portfolio.service_id = services.service_id 
                    ...
                    <form id="myForm" action="update_portfolio.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="project" class="form-control" id="cardTitle"
                                value="<?= htmlspecialchars($row['portfolio_name']) ?>" required>
                        </div>
                        ...
                        <!-- Image Upload -->
                        <div class="mb-3">
                            <label for="image_urle" class="form-label">Image</label>
                            <?php if (!empty($row['image_urle'])): ?>
                                <div class="mb-2">
                                    <img src="upload/<?php echo htmlspecialchars($row['image_urle']); ?>" alt="Current Image" style="max-width: 200px; height: auto;">
                                    <p class="text-muted">Current image</p>
                                </div>
                            <?php endif; ?>
                            <input type="file" class="form-control" name="image_urle" id="image_urle">
