        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Client Messages</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    $limit = 10;
                                    $page = isset($_GET['page']) ? (int)$_GET['page'] : 1; // Get page number
                                    $offset = ($page - 1) * $limit;

                                    // Prepare SQL query to select records
                                    $sql = "SELECT * FROM messages ORDER BY id ASC LIMIT ?, ?";
                                    $stmt = $con->prepare($sql);
                                    $stmt->bind_param("ii", $offset, $limit); // Binding parameters to prevent SQL injection
                                    $stmt->execute();
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='message_details.php?id=" . htmlspecialchars($row['id']) . "' class='text-primary'>" . htmlspecialchars($row['subject']) . "</a></td>";
                                                echo "<td><a href='delete_contact.phpid=" . htmlspecialchars($row['id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'>Delete</a></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        </tbody>
                                    ...
                                    <nav aria-label="Page navigation">
                                        ...
                                        $sql1 = "SELECT COUNT(*) AS total_records FROM messages";
                                        ...
                                        // Previous button
                                        if ($page > 1) {
                                            echo '<li class="page-item"><a class="page-link" href="contact_message.php?page=' . ($page - 1) . '">Prev</a></li>';
                                        }

                                        // Page number links
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            $active = ($i == $page) ? "active" : "";
                                            echo '<li class="page-item ' . $active . '"><a class="page-link" href="contact_message.php?page=' . $i . '">' . $i . '</a></li>';
                                        }

                                        // Next button
                                        if ($page < $total_page) {
                                            echo '<li class="page-item"><a class="page-link" href="contact_message.php?page=' . ($page + 1) . '">Next</a></li>';
                                        }
