       ...
       <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Our Values</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="ourvalues.php">Our Values</a></li>
                ...
                <div class="container py-5">
                    ...
                    // Fetch existing data
                    $sql = "SELECT * FROM ourvalues WHERE id = $id";
                    ...
                    <form id="myForm" action="update_ourvalues.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="4" required><?= htmlspecialchars($row['description']) ?></textarea>
                        </div>
