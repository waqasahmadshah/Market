        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Approche</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="apporaches.php">Approache</a></li>
                ...
                <?php
                    ...
                    <form id="myForm" action="update-approches.php" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Title and Sub-title -->
                        <div class="mb-3">
                            <label for="title" class="form-label">Startegy name</label>
