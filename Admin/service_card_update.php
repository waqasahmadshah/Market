            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Service Card</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="services.php">Services</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Update service card</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="container py-5">
                    ...
                    $sql = "SELECT * 
                            ...
                            WHERE services_card.services_card_id = $id";
                    ...
                    <form id="myForm" action="update_service_card.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="card" class="form-control" id="cardTitle"
                                value="<?= htmlspecialchars($row['services_card_name']) ?>" required>
                        </div>

                        <!-- Icon -->
                        <div class="mb-3">
                            <label for="iconField" class="form-label">Icon</label>
                            <input type="text" name="icon" class="form-control" id="iconField"
                                value="<?= htmlspecialchars($row['icon']) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="description"
                                rows="4" required><?= htmlspecialchars($row['services_card_description']) ?></textarea>
                        </div>
