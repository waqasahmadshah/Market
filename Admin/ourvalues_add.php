       ...
       <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_ourvalues.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" id="icon" placeholder="e.g., fa fa-heart" required>
                        </div>
