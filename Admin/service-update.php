        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Services</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <?php
                    ...
                    <form id="myForm" action="update-services.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" id="icon" value="<?php echo htmlspecialchars($row['icon_class']); ?>" required>
                        </div>
                    
                        <!-- Description -->
                        <div class="mb-3">
                            <label for="short-description" class="form-label">Short Introduction</label>
                            <textarea name="short-description" class="form-control" id="description" rows="4" required><?php echo htmlspecialchars($row['short_desc']); ?></textarea>
                        </div>
                        <!-- Description -->
                        <div class="mb-3">
