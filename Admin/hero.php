                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Hero section data</h4>
                                <a href="form-element.php"><button class="btn btn-primary">Insert</button></a>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM hero_sections ORDER BY id ASC LIMIT {$offset},{$limit}";
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                <a href='hero-update.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-warning'>Edit</button></a>
                                                        <a href='delete-hero.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-danger'>Delete</button></a>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                    ...
                                    <nav aria-label="Page navigation">
                                        ...
                                        if (mysqli_num_rows($result1) > 0) {
                                            ...
                                            // Previous button
                                            if ($page > 1) {
                                                echo '<li class="page-item"><a class="page-link" href="hero.php?page=' . ($page - 1) . '">Prev</a></li>';
                                            }
                                            
                                            // Page number links
                                            for ($i = 1; $i <= $total_page; $i++) {
                                                $active = ($i == $page) ? "active" : "";
                                                echo '<li class="page-item ' . $active . '"><a class="page-link" href="hero.php?page=' . $i . '">' . $i . '</a></li>';
                                            }
                                            
                                            // Next button
                                            if ($page < $total_page) {
                                                echo '<li class="page-item"><a class="page-link" href="hero.php?page=' . ($page + 1) . '">Next</a></li>';
                                            }
