    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        $result = $con->query("SELECT * FROM websitesections WHERE id = $id");
        ...
        // Define allowed ENUM values (must match those in your table)
        $sections = [
            'Our Expertise',
            'FEATURED WORK',
            'OUR APPROACH',
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Edit Website Section</h4>
                            <span class="ml-1">website section</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="website_section.php">Websit section</a></li>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="section_name" class="form-control" required>
                                ...
                                foreach ($sections as $section) {
                                    $selected = ($section === $row['section_name']) ? 'selected' : '';
