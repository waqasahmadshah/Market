        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Portfolio</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Portfolio card</h4>
                                <a href="portfolio_add.php"><button class="btn btn-primary">Insert</button></a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td><a href='delete_portfolio.php?id=" . htmlspecialchars($row['portfolio_id']) . "'><button class='btn btn-danger'>Delete</button></a></td>";
                                                    echo "</tr>";
                                                }
                                            } else {
