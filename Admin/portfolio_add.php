            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="portfolio.php">Projects</a></li>
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_portfoilo.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="service" class="text-dark">Category</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="image_urle" id="exampleInputPassword1" placeholder="img">
                        </div>
