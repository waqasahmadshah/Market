        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Company Contact</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Records</h4>
                                <a href="compeny_contact_add.php"><button class="btn btn-primary">Add</button></a>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                   <?php
                                    ...
                                    $sql = "SELECT * FROM companycontact LEFT JOIN companyinfo ON companycontact.company_id = companyinfo.id ORDER BY companycontact.contact_id ASC";
                                        ...
                                        <table class="table table-responsive-sm">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>
                                                            <a href='delete_compeny_contact.php?id=" . htmlspecialchars($row['contact_id']) . "'>
