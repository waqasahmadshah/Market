        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Projects</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Records</h4>
                                <a href="portfolio_add.php"><button class="btn btn-primary">Add Project</button></a>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td><a href='delete_portfolio.php?id=" . htmlspecialchars($row['portfolio_id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'>Delete</a></td>";
                                                    echo "</tr>";
                                                }
                                            } else {
                                    ...
                                    <nav aria-label="Page navigation">
                                        ...
                                        if (mysqli_num_rows($result1) > 0) {
                                            ...
                                            // Previous button
                                            if ($page > 1) {
                                                echo '<li class="page-item"><a class="page-link" href="portfolio.php?page=' . ($page - 1) . '">Prev</a></li>';
                                            }
                                            ...
                                            // Next button
                                            if ($page < $total_page) {
                                                echo '<li class="page-item"><a class="page-link" href="portfolio.php?page=' . ($page + 1) . '">Next</a></li>';
                                            }
