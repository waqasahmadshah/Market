            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="compeny_contact.php">Company contact</a></li>
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_compeny_contact.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="Contact" class="form-control" id="Contact" required onkeypress="return event.charCode >= 48 && event.charCode <= 57 ">
                        </div>
