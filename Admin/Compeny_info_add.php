            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="compeny_info.php">Company</a></li>
                ...
                <div class="container py-5">
                    ...
                    <form id="myForm" action="insert_compeny_info.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="whatsapp" class="form-control" pattern="^92[0-9]{10}$" placeholder="e.g. 923209955837" required>
                        </div>
                        <div class="mb-3">
