        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_feature_services.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="feature_title" class="form-label">Feature Name</label>
                            <input type="text" name="feature_title" class="form-control" id="feature_titles" required>
                        </div>
