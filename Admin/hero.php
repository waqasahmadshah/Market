                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Hero Recods</h4>
                                <a href="hero_add.php"><button class="btn btn-primary">Add</button></a>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM hero_sections ORDER BY id ASC";
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                <a href='hero-update.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-warning'>Edit</button></a></td>
                                                        <td><a href='delete-hero.php?id=" . htmlspecialchars($row['id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'>Delete</a>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                            ?>
