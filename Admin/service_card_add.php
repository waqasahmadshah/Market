        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add service Card</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_service_card.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="card_title" class="form-control" id="feature_titles" required>
                        </div>

                        <div class="mb-3">
                            <label for="feature_title" class="form-label">Icon</label>
                            <input type="text" name="icon" class="form-control" id="feature_titles" required>
                        </div>
