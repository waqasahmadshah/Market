        ...
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            ...
            if ($stmt) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<div class='alert alert-danger m-4'>Message not found.</div>";
                    exit;
                }
            } else {
                // SQL prepare failed
                echo "<div class='alert alert-danger m-4'>Database error. Please try again later.</div>";
                exit;
            }
        } else {
            // Invalid or missing ID
            echo "<div class='alert alert-warning m-4'>Invalid or missing message ID.</div>";
            exit;
        }
        ?>


        <!-- HTML layout for message display -->
        <div class="content-body">
            <div class="container-fluid">
                <h2 class="text-primary mb-4">📩 Message Details</h2>

                <div class="card shadow rounded">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Full Message Information</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><strong>Received at:</strong> <?php echo date('h:i A, d M Y', strtotime($message['created_at'])); ?></p>
                            </div>
                        </div>

                        <div class="text-end">
                            <a href="messages_list.php" class="btn btn-secondary">
                                ← Back to Messages
                            </a>
                        </div>
                    </div>
