        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    <form id="myForm" action="update_users.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"  name="Username" class="form-control" id="Username" value="<?php echo htmlspecialchars($row['username']); ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="full_name" class="form-control" id="full_name" value="<?php echo htmlspecialchars($row['full_name']); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="dob" class="form-label">DOB</label>
                            <input type="date" name="dob" class="form-control" id="dob" value="<?php echo htmlspecialchars($row['date_of_birth']); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="Phone" class="form-label">Phone No</label>
                            <input type="tel" name="Phone" class="form-control" id="Phone" value="<?php echo htmlspecialchars($row['phone_number']); ?>"  pattern="[0-9]*" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                        </div>
                        <div class="mb-3 position-relative">
                            <label for="Password" class="form-label">Password</label>
                            <input type="password" name="Password" class="form-control" id="Password" value="<?php echo htmlspecialchars($row['password_hash']); ?>"required>
                            <span class="position-absolute" style="top: 38px; right: 10px; cursor: pointer;" onclick="togglePassword()">
                                <img id="eyeIcon" src="https://img.icons8.com/ios-glyphs/24/closed-eye.png" alt="Toggle Password" />
                            </span>
                        </div>
                        ...
                        <script>
                            function togglePassword() {
                                ...
                                if (passwordInput.type === 'password') {
                                    ...
                                    eyeIcon.src = 'https://img.icons8.com/ios-glyphs/24/visible--v1.png'; // open eye
                                } else {
                                    passwordInput.type = 'password';
                                    eyeIcon.src = 'https://img.icons8.com/ios-glyphs/24/closed-eye.png'; // closed eye
                                }
                            }
                        </script>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($row['profile_picture_url'])): ?>
                                <div class="mb-2">
                                    <img src="upload/<?php echo htmlspecialchars($row['profile_picture_url']); ?>" alt="Current Image" style="max-width: 200px; height: auto;">
