...
// // Wait for the DOM to be fully loaded
// document.addEventListener("DOMContentLoaded", () => {
//   // Error handling for AOS initialization
//   if (typeof AOS !== 'undefined') {
//     try {
//       AOS.init({
//         duration: 1000,
...
//   // Error handling for navbar scroll effect
//   const navbar = document.querySelector(".navbar");
//   if (navbar) {
//     try {
//       let lastScrollTop = 0;
...
//   // Error handling for testimonial slider
//   const testimonialItems = document.querySelectorAll(".testimonial-item");
//   const dots = document.querySelectorAll(".dot");
//   const prevBtn = document.querySelector(".testimonial-prev");
//   const nextBtn = document.querySelector(".testimonial-next");
...
//       showTestimonial(0);
//     } catch (error) {
//       console.error("Testimonial slider error:", error);
//     }
//   }

//   // Error handling for back to top button
//   const backToTopBtn = document.querySelector(".back-to-top");
//   if (backToTopBtn) {
//     try {
//       const scrollThreshold = 300;
...
//   // Error handling for current year in footer
//   const yearElement = document.getElementById("current-year");
//   if (yearElement) {
//     try {
//       yearElement.textContent = new Date().getFullYear();
//     } catch (error) {
//       console.error("Current year setting error:", error);
//     }
//   }

//   // Error handling for service categories
//   const serviceCategories = document.querySelectorAll(".service-category");
//   if (serviceCategories.length > 0) {
//     try {
//       serviceCategories.forEach(category => {
...
//   // Error handling for portfolio categories
//   const portfolioCategories = document.querySelectorAll(".portfolio-category, .filter-btn");
//   const portfolioItems = document.querySelectorAll(".portfolio-item");
...
//       });
//     } catch (error) {
//       console.error("Portfolio categories error:", error);
//     }
//   }

//   // Error handling for animate elements
//   const animateElements = document.querySelectorAll(".animate");
//   if (animateElements.length > 0) {
//     try {
//       let ticking = false;
...
//       checkIfInView();
//     } catch (error) {
//       console.error("Animate elements error:", error);
//     }
//   }

//   // Error handling for portfolio hover effect
//   const portfolioImgs = document.querySelectorAll(".portfolio-img, .portfolio-card-img");
//   try {
//     portfolioImgs.forEach((img) => {
//       const imgElement = img.querySelector("img");
...
//     });
//   } catch (error) {
//     console.error("Portfolio hover effect error:", error);
//   }
...
//   // Error handling for counter animation
//   const statItems = document.querySelectorAll('.stat-item h3, .featured-stat h3');
...
//   // Error handling for parallax effect
//   const heroSections = document.querySelectorAll('#hero, .portfolio-hero, .about-hero, .contact-hero, .services-hero, .service-detail-hero, .case-study-hero');
...
//   // Error handling for client logo hover effects
//   const clientLogos = document.querySelectorAll('.client-logo');
//   if (clientLogos.length > 0) {
//     try {
//       clientLogos.forEach(logo => {
...
//       });
//     } catch (error) {
//       console.error("Client logo hover effect error:", error);
//     }
//   }
  
//   // Error handling for animation classes
//   const animatedElements = document.querySelectorAll('[data-aos]');
//   if ('IntersectionObserver' in window && animatedElements.length > 0) {
//     try {
//       const animationObserver = new IntersectionObserver((entries) => {
