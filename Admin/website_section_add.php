    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="website_section.php">website Sections</a></li>
        ...
        <div class="container py-5">
            <form action="insert_section.php" method="POST">
                <!-- Success Placeholder (optional JS) -->
                ...
                <div class="mb-3">
                    ...
                    <select name="section_name" class="form-control" id="section_name" required>
                        ...
                        <option value="Our Expertise">Our Expertise</option>
