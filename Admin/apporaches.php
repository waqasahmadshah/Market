        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">Approches</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Records</h4>
                                <a href="approches_add.php"><button class="btn btn-primary">Add</button></a>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM process ORDER BY id ASC LIMIT {$offset},{$limit}";
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='approches_update.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-warning'>Edit</button></a></td>
                                                    <td><a href='delete_approaches.php?id=" . htmlspecialchars($row['id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\");'>Delete</a>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                    ...
                                    <nav aria-label="Page navigation">
                                        ...
                                        if (mysqli_num_rows($result1) > 0) {
                                            ...
                                            // Previous button
                                            if ($page > 1) {
                                                echo '<li class="page-item"><a class="page-link" href="apporaches.php?page=' . ($page - 1) . '">Prev</a></li>';
                                            }
                                            
                                            // Page number links
                                            for ($i = 1; $i <= $total_page; $i++) {
                                                $active = ($i == $page) ? "active" : "";
                                                echo '<li class="page-item ' . $active . '"><a class="page-link" href="apporaches.php?page=' . $i . '">' . $i . '</a></li>';
                                            }
                                            
                                            // Next button
                                            if ($page < $total_page) {
                                                echo '<li class="page-item"><a class="page-link" href="apporaches.php?page=' . ($page + 1) . '">Next</a></li>';
                                            }
