                ...
                <?php
                    ...
                    <form id="myForm" action="update-hero.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="button_text" class="form-control" id="buttonText" value="<?php echo htmlspecialchars($row['button_text']); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="buttonLink" class="form-label">Button Link</label>
                            <input type="text" name="button_link" class="form-control" id="buttonLink" value="<?php echo htmlspecialchars($row['button_link']); ?>">
                        </div>
