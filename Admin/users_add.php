        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="container py-5">
                    <form id="myForm" action="insert_users.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="Phone" class="form-control" id="Phone"  pattern="[0-9]*" required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                        </div>
