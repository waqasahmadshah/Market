        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                <h1 class="main text-primary">About section</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Services</h4>
                                <a href="about_add.php"><button class="btn btn-primary">Insert</button></a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                <a href='service-update.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-warning'>Edit</button></a></td>
                                                        <td><a href='delete_about.php?id=".htmlspecialchars($row['id'])."'><button class='btn btn-danger'>Delete</button></a>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                            ?>
