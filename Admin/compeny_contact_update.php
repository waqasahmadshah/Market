        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Company Contact</span>
                        </div>
                    </div>
                ...
                <?php
                    ...
                    // Fetch existing data
                    $sql = "SELECT * FROM companycontact LEFT JOIN companyinfo ON companycontact.company_id = companyinfo.id ORDER BY companycontact.contact_id ='$id'";
                    ...
                    <form id="myForm" action="update_compeny_contact.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Address" class="form-control" id="Address" value="<?= htmlspecialchars($row['address']) ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Website" class="form-control" id="Website" value="<?= htmlspecialchars($row['website']) ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="Contact" class="form-label">Company Contact No</label>
                            <input type="tel" name="Contact" class="form-control" id="Contact" value="<?= htmlspecialchars($row['phone_number']) ?>" required onkeypress="return event.charCode >= 48 && event.charCode <= 57 ">
                        </div>
