        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Add New Project</span>
                        </div>
                    </div>
                ...
                <div class="container py-5">
                    <form id="projectForm" action="insert_projects.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="client" class="form-control" id="project_name" required>
                        </div>
