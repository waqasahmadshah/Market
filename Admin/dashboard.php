                        ...
                        <div class="card" style="padding: 30px 10px">
                            <div class="stat-widget-one d-flex align-items-center">
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit"><?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM users")); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card" style="padding: 30px 10px">
                            <div class="stat-widget-one d-flex align-items-center">
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit"><?php echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM teammember")); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit">
                                        <?php 
                                            ...
                                            echo mysqli_num_rows(mysqli_query($con, "SELECT * FROM projects")); 
                                        ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                // Fetch latest messages (limit to 5 or as needed)
                                $sql = "SELECT name, subject FROM messages ORDER BY id DESC LIMIT 5";
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="d-flex text-dark justify-content-between">
                                                    <strong class="ml-5"><?php echo htmlspecialchars($msg['name']); ?></strong>
                                                    <span class="text-muted"><?php echo htmlspecialchars($msg['subject']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                            include "configure.php"; // Make sure this file correctly sets $con

                                            // Check DB connection
                                            if (!$con) {
                                                echo '<tr><td colspan="5" class="text-danger text-center">Database connection failed.</td></tr>';
                                            } else {
