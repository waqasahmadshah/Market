            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="row page-titles mx-0">
                        ...
                        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Insertion Form</a></li>
                            </ol>
                        </div>
                    </div>
                    <!-- row -->
                    ...
                    <div class="container py-5">
                        <form id="myForm" action="insert_about.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="heading" class="form-label">Postion</label>
                                <input type="text" name="Postion" class="form-control" id="title" required>
                            </div>
                            <div class="mb-3">
                                <label for="heading" class="form-label">Title</label>
                                <input type="text" name="heading" class="form-control" id="title" required>
                            </div>
