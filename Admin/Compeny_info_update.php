        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Company Information</span>
                        </div>
                    </div>
                ...
                <?php
                    ...
                    <form id="myForm" action="update_company_info.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="<?php echo htmlspecialchars($row['company_name']);?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="Copyright" class="form-label">Company Copyright</label>
                            <input type="text" name="Copyright" class="form-control" id="Copyright" value="<?php echo htmlspecialchars($row['copyright_text']);?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="Description" class="form-label">Description</label>
                            <input type="text" name="Description" class="form-control" id="Description" value="<?php echo htmlspecialchars($row['company_description']);?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="whatsapp" class="form-label">Whatsapp No</label>
                            <input type="text" name="whatsapp" class="form-control" pattern="^92[0-9]{10}$" placeholder="e.g. 923209955837" value="<?php echo htmlspecialchars($row['whatsapp']);?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($row['logo_url'])): ?>
                                <div class="mb-2">
                                    <img src="upload/<?php echo htmlspecialchars($row['logo_url']); ?>" alt="Current Image" style="max-width: 200px; height: auto;">
