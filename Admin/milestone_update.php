            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="mile_stone.php">Milestone</a></li>
                ...
                <div class="container py-5">
                    ...
                    <form id="myForm" action="update_milestone.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="cardTitle"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="year" class="form-control" id="iconField"
                                value="<?= htmlspecialchars($row['year']) ?>" required>
                        </div>
                        <!-- Icon -->
                        <div class="mb-3">
